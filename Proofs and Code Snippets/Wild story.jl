...
# ╔═╡ 3fae200a-7334-4094-802d-da0dfd133f7d
using Symbolics

# ╔═╡ e9154fa8-3013-4301-a71d-18d8d8e4ce10
@variables yB

# ╔═╡ b2be1bd6-cfff-4554-86c2-a1f1afbb6666
@variables x

# ╔═╡ 944b5c17-9367-48ca-a449-fe4152fa692a
 D = Differential(x)

# ╔═╡ f04cfa6b-2e93-4df2-a987-09715a01d2d7
y_coeffs, = @variables a[0:7]

# ╔═╡ 357ba991-34b0-41e0-8eb0-deeada5de976
y = series(y_coeffs, x)

# ╔═╡ 2aae7a29-cf0c-44e7-b612-e2dbf3d13629
yp= expand_derivatives(y)

# ╔═╡ e6c072f1-7e32-4ea0-b9b1-4b74df8957dd
ypp=D(yp)

# ╔═╡ 6157d530-18c1-4457-af68-125f5a395b95
Problem = 1 + (yp)^2-2*ypp*(yB-y) ~ 0

# ╔═╡ 614d55e9-f1b5-4cb3-9b8b-6be29d4c6999
Problemm= y^5+y ~ 1
